...
*/
/*
cursorcolor - 改变光标颜色的十六进制，默认值是“＃000000”
cursoropacitymin - 改变不透明度非常光标是无效的（scrollabar“隐藏”状态），范围从1到0，默认为0（隐藏）
非常光标cursoropacitymax - 改变不透明度是积极的（scrollabar“可见”状态），范围从1到0，默认值是1（完全不透明）
cursorwidth - 光标的宽度像素，默认为5（你可以写“5PX”太）
cursorborder - CSS定义光标边界，默认为“1px固体＃FFF”
cursorborderradius - 在光标像素的边界半径，默认为??“递四方”
ZIndex的 - 改变为滚动条的DIV的z-index值，默认值是9999
scrollspeed - 滚动速度，默认值是60
mousescrollstep - 滚动鼠标滚轮的速度，默认值是40（像素）
touchbehavior - 使光标拖动滚动触摸设备，在桌面计算机，默认为false
...
cursorminheight，设置最低光标高度的像素（默认值：20）
...
spacebarenabled，使上下滚动时，按下空格键（默认：true）
railpadding，设置填充为铁路栏（默认：顶：0，右：0，左：0，底部：0}）
